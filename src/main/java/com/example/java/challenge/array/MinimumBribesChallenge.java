...
public class MinimumBribesChallenge {
    public static void main(String[] args) {
        log.info("MinimumBribes start");
        log.info("MinimumBribes - result: {}", MinimumBribes.minimumBribes(List.of(2, 1, 5, 3, 4)));
        log.info("MinimumBribes - result: {}", MinimumBribes.minimumBribes(List.of(2, 5, 1, 3, 4)));
        log.info("MinimumBribes - result: {}", MinimumBribes.minimumBribes(List.of(5, 1, 2, 3, 7, 8, 6, 4)));
        log.info("MinimumBribes - result: {}", MinimumBribes.minimumBribes(List.of(1, 2, 5, 3, 7, 8, 6, 4)));
        log.info("MinimumBribes - result: {}", MinimumBribes.minimumBribes(List.of(1, 2, 5, 3, 4, 7, 8, 6)));
        log.info("MinimumBribes end");
    }

    /**
     * MinimumBribes class
     */
    private static class MinimumBribes {
