...
public class BrickBlockChallenge {
    ...
    public static void main(String[] args) {
        log.info("BrickBlock start");
        log.info("BrickBlock result: {}", BrickBlock.legoBlocks(1, 2));
        log.info("BrickBlock result: {}", BrickBlock.legoBlocks(1, 3));
        log.info("BrickBlock result: {}", BrickBlock.legoBlocks(1, 4));
        log.info("BrickBlock result: {}", BrickBlock.legoBlocks(2, 2));
        log.info("BrickBlock result: {}", BrickBlock.legoBlocks(4, 5));
        log.info("BrickBlock result: {}", BrickBlock.legoBlocks(4, 6));
        log.info("BrickBlock result: {}", BrickBlock.legoBlocks(4, 7));
        log.info("BrickBlock result: {}", BrickBlock.legoBlocks(694, 335));
        log.info("BrickBlock end");
    }

    /**
     * BrickBlock class
     */
    private static class BrickBlock {
